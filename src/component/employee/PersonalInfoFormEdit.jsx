...
class PersonalInfoFormEdit extends Component {
  state = {
    ...
    PANcardNoData: this.props.editData["panCardNumber"] || "",
    HobbiesData: this.props.editData["hobby"] || "",
    PresentAddressData: this.props.editData["address"] || "",
    PermanentAddressData: this.props.editData["permanentAddress"] || ""
  ...
  onPermanentAddressDataChange(e) {
    this.setState({ PermanentAddressData: e.target.value });
  }
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  as="textarea"
                  rows="3"
                  plassholder=" Permanent Address"
                  required
                  value={this.state.PermanentAddressData}
                  onChange={value => this.onPermanentAddressDataChange(value)}
                />
              </Col>
            </Form.Group>
