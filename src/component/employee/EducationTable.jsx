  ...
  loadEducationData = () => {
    ...
    axios
      ...
      .then(response => {
        ...
        console.log("data", this.educationObj["collegeName"]);
        //this.educationObj.map(data => {
          //console.log("data", data["grade"]);
          let data = this.educationObj;
          let temp = {
            data,
            SchoolUniversity: data["nameOfUni"],
            Degree: data["degree"],
            Grade: data["grade"],
            PassingOfYear: data["passingYear"],
