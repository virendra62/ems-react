    ...
    axios
      ...
      .then(response => {
        ...
        let temp = {
          ...
          ContactNo: data["phone"] || "Not Avaiable",
          Email: data["email"] || "Not Avaiable",
          PANcardNo: data["panCardNumber"] || "Not Avaiable",
          DOB: data["dob"].slice(0, 10) || "Not Avaiable",
          Hobbies: data["hobby"] || "Not Avaiable",
          PresentAddress: data["address"] || "Not Avaiable",
          PermanentAddressData: data["permanentAddress"] || "Not Avaiable",
